...
(function () {
            ...
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        borderSkipped: false,
                        backgroundColor: "#fff",
                        data: [price[4], price[5], price[6], price[7], price[8], price[9], price[10], price[11], price[12]],
                        maxBarThickness: 4
                    },],
                },
                options: {
            ...
            new Chart(ctx3, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        dailyArr[21], dailyArr[22], dailyArr[23], dailyArr[24], dailyArr[25], dailyArr[26], dailyArr[27], dailyArr[28], dailyArr[29], dailyArr[30], dailyArr[31]],
                        maxBarThickness: 6
    ...
    var ctx3 = document.getElementById("chart-line-year").getContext("2d");
