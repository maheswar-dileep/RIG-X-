          ...
          if ($("#order-chart").length) {
            var areaData = {
              ...
              datasets: [
                ...
                {
                  data: [pricePaid[1], pricePaid[2], pricePaid[3], pricePaid[4], pricePaid[5], pricePaid[6], pricePaid[7], pricePaid[8], pricePaid[9], pricePaid[10], pricePaid[11], pricePaid[12]],
                  borderColor: [
                    '#F09397'
                  ],
                  borderWidth: 2,
